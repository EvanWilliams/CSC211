	...
	/**
	 ...
	 Class invariant: A Person always has a date of birth, and if the Person has a
	 date of death, then the date of death is equal to or later than the date of birth.
	*/
	 class Person implements Cloneable
	{
	    ...
	    Date NullDate = null;
	    Date newDate = clonex(NullDate);
		/**
		 Warning: these are poorly written constructors.  This is to force you to implement
		 the clone methods properly
		 */
